...
class CreateDeviceRatingsUniLabTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('device_ratings_uni_lab', function (Blueprint $table) {
          $table->id();
            ...
            $table->foreign('reservation_id')->references('id')->on('reservation_uni_lab')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('device_ratings_uni_lab');
    }
}
