...
{{--                                        @method('PUT')--}}
                                        ...
                                        <div class="container col-xs-12 col-sm-12 col-md-12 mb-2 morerows addRow" id="addRow">
                                            <div class="row form-group">
                                                <div class="col-md"><input type="text" name="services[]" class="services form-control" placeholder="Services provided" value="{{old('services.0')}}"></div>
                                                <div class="col-md"><input type="text" name="servicesArabic[]" class="services form-control" placeholder="الخدمة بالعربي" value="{{old('servicesArabic.0')}}"></div>
                                                <div class="col-md"><input type="text" name="cost[]" class="cost form-control" placeholder="Cost/Service" value="{{old('cost.0')}}"></div>
                                                <div class="col-md"><input type="text" name="costArabic[]" class="cost form-control" placeholder="السعر/ لكل" value="{{old('costArabic.0')}}"></div>
                                                <div class="col-md"><input type="text" name="desc_service[]" class="desc form-control" placeholder="وصف الخدمة" value="{{old('desc_service.0')}}"></div>
                                            </div>
                                        </div>
                                        <div class="form-group form-primary">
    ...
    <script id="document-template" type="text/x-handlebars-template">
        <div class="row form-group delete_add_more_item" id="delete_add_more_item">
            <div class="col-md"><input type="text" name="services[]" class="services form-control" placeholder="Services provided"></div>
            <div class="col-md"><input type="text" name="servicesArabic[]" class="services form-control" placeholder="الخدمة بالعربي"></div>
            <div class="col-md"><input type="text" name="cost[]" class="cost form-control" placeholder="Cost/Service"></div>
            <div class="col-md"><input type="text" name="costArabic[]" class="cost form-control" placeholder="السعر/ لكل"></div>
            <div class="col-md"><input type="text" name="desc_service[]" class="desc form-control" placeholder="وصف الخدمة"></div>
            <button class="btn btn-sm bg-transparent removeaddmore"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" style="fill: rgba(245, 8, 8, 1);"><path d="M5 20a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8h2V6h-4V4a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v2H3v2h2zM9 4h6v2H9zM8 8h9v12H7V8z"></path><path d="M9 10h2v8H9zm4 0h2v8h-2z"></path></svg></button>
