                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            <li class="{{ Route::currentRouteNamed( 'uniHome' ) ?  'active' : '' }}">
                                <a href="/uniHome" class="waves-effect waves-dark">
                                    ...
                                    <span class="pcoded-mtext" data-i18n="nav.dash.main">{{ Request::is('userReservation*') ? 'Reservations' : 'Dashboard' }}</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>
                            @if(auth()->user()->hasRole(['faculty', 'university', 'admin']))  
                                <li>
                                    
                                    <a href="{{ route('admin-reservations') }}" class="waves-effect waves-dark">
                                            ...
                                            <span class="pcoded-mtext" data-i18n="nav.form-components.main">D.Reservations</span>
                                            <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>  
                            @endif 
                            ...
                            @if(auth()->user()->hasRole('admin'))  
                                <li>    
                                    <a href="{{ route('admin.workshops.index') }}" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1); "><path d="M9.5 12c2.206 0 4-1.794 4-4s-1.794-4-4-4-4 1.794-4 4 1.794 4 4 4zm1.5 1H8c-3.309 0-6 2.691-6 6v1h15v-1c0-3.309-2.691-6-6-6z"></path><path d="M16.604 11.048a5.67 5.67 0 0 0 .751-3.44c-.179-1.784-1.175-3.361-2.803-4.44l-1.105 1.666c1.119.742 1.8 1.799 1.918 2.974a3.693 3.693 0 0 1-1.072 2.986l-1.192 1.192 1.618.475C18.951 13.701 19 17.957 19 18h2c0-1.789-.956-5.285-4.396-6.952z"></path></svg></span>
                                            <span class="pcoded-mtext" data-i18n="nav.form-components.main">Workshops</span>
                                            <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li>    
                                 <a href="{{ route('mail-logs') }}" class="waves-effect waves-dark"> 
                                        <span class="pcoded-micon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);">
                                                <path d="M20 4H4c-1.103 0-2 .897-2 2v12c0 1.103.897 2 2 2h16c1.103 0 2-.897 2-2V6c0-1.103-.897-2-2-2zm0 2v.511l-8 6.223-8-6.222V6h16zM4 18V9.044l7.386 5.745a.994.994 0 0 0 1.228 0L20 9.044 20.002 18H4z"></path>
                                            </svg>
                                        </span> 
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Mail logs</span> 
                                        <span class="pcoded-mcaret"></span> 
                                    </a>
                                </li>
                                <li>    
                                    <a href="{{ route('certificate.requests') }}" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1); "><path d="M9.5 12c2.206 0 4-1.794 4-4s-1.794-4-4-4-4 1.794-4 4 1.794 4 4 4zm1.5 1H8c-3.309 0-6 2.691-6 6v1h15v-1c0-3.309-2.691-6-6-6z"></path><path d="M16.604 11.048a5.67 5.67 0 0 0 .751-3.44c-.179-1.784-1.175-3.361-2.803-4.44l-1.105 1.666c1.119.742 1.8 1.799 1.918 2.974a3.693 3.693 0 0 1-1.072 2.986l-1.192 1.192 1.618.475C18.951 13.701 19 17.957 19 18h2c0-1.789-.956-5.285-4.396-6.952z"></path></svg></span>
                                            <span class="pcoded-mtext" data-i18n="nav.form-components.main">Certificate Requests</span>
                                            <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                            ...
                            @if(auth()->user()->hasRole('university'))   
                                <li>    
                                    <a href="{{ route('uniworkshops.index') }}" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1); "><path d="M9.5 12c2.206 0 4-1.794 4-4s-1.794-4-4-4-4 1.794-4 4 1.794 4 4 4zm1.5 1H8c-3.309 0-6 2.691-6 6v1h15v-1c0-3.309-2.691-6-6-6z"></path><path d="M16.604 11.048a5.67 5.67 0 0 0 .751-3.44c-.179-1.784-1.175-3.361-2.803-4.44l-1.105 1.666c1.119.742 1.8 1.799 1.918 2.974a3.693 3.693 0 0 1-1.072 2.986l-1.192 1.192 1.618.475C18.951 13.701 19 17.957 19 18h2c0-1.789-.956-5.285-4.396-6.952z"></path></svg></span>
                                            <span class="pcoded-mtext" data-i18n="nav.form-components.main">Workshops</span>
                                            <span class="pcoded-mcaret"></span>
                                    </a>
                            ...
                            @if(auth()->user()->hasRole(['university', 'admin']))  
                                <li>    
                                    <a href="{{ route('admin.workshops.reservations') }}" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1); "><path d="M9.5 12c2.206 0 4-1.794 4-4s-1.794-4-4-4-4 1.794-4 4 1.794 4 4 4zm1.5 1H8c-3.309 0-6 2.691-6 6v1h15v-1c0-3.309-2.691-6-6-6z"></path><path d="M16.604 11.048a5.67 5.67 0 0 0 .751-3.44c-.179-1.784-1.175-3.361-2.803-4.44l-1.105 1.666c1.119.742 1.8 1.799 1.918 2.974a3.693 3.693 0 0 1-1.072 2.986l-1.192 1.192 1.618.475C18.951 13.701 19 17.957 19 18h2c0-1.789-.956-5.285-4.396-6.952z"></path></svg></span>
                                            <span class="pcoded-mtext" data-i18n="nav.form-components.main">Workshop.Reservations</span>
                                            <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                            @endif 
                            @if(auth()->user()->hasRole('faculty')) 
                                <li>
                                    <a href="{{ route('facworkshop', [auth()->user()->uni_id,auth()->user()->fac_id]) }}" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1); "><path d="M9.5 12c2.206 0 4-1.794 4-4s-1.794-4-4-4-4 1.794-4 4 1.794 4 4 4zm1.5 1H8c-3.309 0-6 2.691-6 6v1h15v-1c0-3.309-2.691-6-6-6z"></path><path d="M16.604 11.048a5.67 5.67 0 0 0 .751-3.44c-.179-1.784-1.175-3.361-2.803-4.44l-1.105 1.666c1.119.742 1.8 1.799 1.918 2.974a3.693 3.693 0 0 1-1.072 2.986l-1.192 1.192 1.618.475C18.951 13.701 19 17.957 19 18h2c0-1.789-.956-5.285-4.396-6.952z"></path></svg></span>
                                            <span class="pcoded-mtext" data-i18n="nav.form-components.main">Workshops</span>
                                            <span class="pcoded-mcaret"></span>
                                    </a>
...
{{--                                @endif--}}
                            ...
                            @if(auth()->user()->hasRole(['admin']))  
                                <li>
                                    ...
                                    <a href="{{ route('getServices') }}" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1); "><path d="M9.5 12c2.206 0 4-1.794 4-4s-1.794-4-4-4-4 1.794-4 4 1.794 4 4 4zm1.5 1H8c-3.309 0-6 2.691-6 6v1h15v-1c0-3.309-2.691-6-6-6z"></path><path d="M16.604 11.048a5.67 5.67 0 0 0 .751-3.44c-.179-1.784-1.175-3.361-2.803-4.44l-1.105 1.666c1.119.742 1.8 1.799 1.918 2.974a3.693 3.693 0 0 1-1.072 2.986l-1.192 1.192 1.618.475C18.951 13.701 19 17.957 19 18h2c0-1.789-.956-5.285-4.396-6.952z"></path></svg></span>
