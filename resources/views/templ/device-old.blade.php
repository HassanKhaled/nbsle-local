                    ...
                    <ul>
                        ...
                        <li class="row" hidden>
                            <div class="col-md-12 bg-light text-right">
                                <a href="{{route('reservation',[$dev->id,$dev->lab_id,$central,$uni_id,$uniname])}}"><input type="button" name="booking" value="Booking" class="btn btn-round btn-warning" /> </a>
                                <a href="{{route('user-reservations',[$dev->id,$dev->lab_id,$central,$uni_id,$uniname])}}"><input type="button" name="cancel" value="Cancel" class="btn btn-round btn-success" /> </a>
                             </div>
