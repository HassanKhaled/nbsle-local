...
Route::get('/contact', function () {
    return view('templ/contact');
});
//Route::get('/c', function () {return view('templ/index');});

Route::get('/about', function () {
    return view('templ/about');
});
Route::get('/services', function () {
    return view('templ/services');
});
Route::get('/vm', function () {
    return view('templ/visionNDmission');
});
Route::get('/obj', function () {
    return view('templ/objective');
});
...
*/
    ...
    // Method 1: Using map() - Recommended
...
Route::group(['middleware' => ['auth', 'role:admin|university']], function () {
    ...
    // Workshops Adv. Uni   
    Route::get('/uniworkshops', [WorkshopsController::class, 'showUnivWorkshops'])->name('uniworkshops.index');
...
Route::group(['middleware' => ['auth', 'role:admin']], function () {
    ...
    Route::put('/certificate/{id}/bulk-action', [RequestController::class, 'bulkAction'])
